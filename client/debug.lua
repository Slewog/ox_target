...
ox_target:addGlobalObject({
    {
        name = 'menuDebugObject',
        openMenu = 'ox_target:debugObjectMenu',
        icon = 'fa-solid fa-bug',
        label = 'Outils de debug'
    },
    {
        name = 'ox_target:debugObjectMenuOptions4',
        menuName = 'ox_target:debugObjectMenu',
        icon = 'fa-solid fa-door-open',
        label = 'Condamner porte',
        onSelect = function(data)
            TriggerEvent('atl_lib:door:CreateLockedDoors', {coords = data.coords, entity = data.entity, model = GetEntityModel(data.entity), archetype = GetEntityArchetypeName(data.entity)})
        end
    }
})